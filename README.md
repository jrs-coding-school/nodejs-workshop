# Favorite Movies NodeJS  Tutorial

## Setup

```
git clone https://github.com/jrs-innovation-center/nodejs-workshop.git movie-favorites
cd movie-favorites
npm install
npm start
```
...
## Step 1 - Load Data from db.json into couchdb

---

## Step 2 - List movies favorites endpoint from api

---

## Step 3 - Add movie favorite endpoint

---

## Step 4 - proxy movie api search

---

## Step 5 - Create export stream to csv
---

## Step 6 - Create export stream to mysql
...
https://github.com/jrs-innovation-center/jrscode-react-starter.git

Then clone it from your github into a directory that
will be your project name

`git clone [your forked repo] [project name]`

> eg. git clone https://github.com/twilson63/jrscode-react-starter.git agend_app

---

## Running your project locally.

Once you have cloned the project, you want to `cd`
into the project folder and run the install commands.
...
The web application is running on port 3000 of localhost
The api application is running on port 4000 of localhost
The docs application is running on port 5000 of localhost

[web http://localhost:3000](http://localhost:3000)

[api http://localhost:4000](http://localhost:4000)

[docs http://localhost:5000](http://localhost:5000)

* Styleguide is Standard
...
The above db.json will create three api resources:
